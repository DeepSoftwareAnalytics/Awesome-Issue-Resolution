...
def migrate_table1_datasets():
    ...
    session = get_session()
    csv_file = config.DATA_DIR / 'tables' / 'table1.csv'
...
def migrate_table2_training_datasets():
    ...
    session = get_session()
    csv_file = config.DATA_DIR / 'tables' / 'table2.csv'
...
def migrate_table3_sft_methods():
    ...
    session = get_session()
    csv_file = config.DATA_DIR / 'tables' / 'table3.csv'
...
def migrate_table4_rl_methods():
    ...
    session = get_session()
    csv_file = config.DATA_DIR / 'tables' / 'table4.csv'
...
def migrate_table5_foundation_models():
    ...
    session = get_session()
    csv_file = config.DATA_DIR / 'tables' / 'table5.csv'
